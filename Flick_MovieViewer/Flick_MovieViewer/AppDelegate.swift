...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let nowPlayingNavigationController = storyboard.instantiateViewController(withIdentifier: "MovieNav") as! UINavigationController
        ...
        let topRatedNavigationController = storyboard.instantiateViewController(withIdentifier: "MovieNav") as! UINavigationController
